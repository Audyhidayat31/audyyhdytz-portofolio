...
const EXPERIENCE = [
  {
    ...
    description: 'Membangun aplikasi web responsif dengan React dan framework JavaScript modern.',
    type: 'Profesional',
  },
  {
    id: 2,
    title: 'Developer Web Lepas',
    company: 'Pekerja Mandiri',
    period: '2023 - Sekarang',
    description: 'Mengembangkan solusi web khusus untuk berbagai klien dan startup.',
    type: 'Freelance',
  },
  {
    id: 3,
    ...
    period: '2023 - 2024',
    description: 'Membangun aplikasi jejaring sosial full-stack dengan fitur real-time.',
    type: 'Proyek',
  },
];
